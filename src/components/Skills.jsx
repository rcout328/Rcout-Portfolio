const Skills = () => {
  return (
    <div className="flex flex-col ml-10 mr-10 mt-20 phone:ml-5 phone:mr-5 mid:ml-5 mid:mr-5 mac:ml-5 mac:mr-5 mal:mr-5 mal:ml-5 mad:mt-20 mad:mr-20 mad:ml-20">
