...
const About = () => {
  return (
    <>
      ...
      <div className="flex flex-col mt-20 ml-10 phone:ml-5 phone:mr-5 mid:mr-5 mid:ml-5 mac:mr-5 mac:ml-5">
        <div className="flex flex-row text-8xl font-bold mt-3 phone:text-6xl mid:text-6xl mac:text-6xl mal:text-7xl">
          <span>About me</span>
