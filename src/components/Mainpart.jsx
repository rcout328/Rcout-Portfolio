...
const Mainpart = () => {
  return (
    <div className="flex flex-col ml-10 mt-40 phone:mt-20 min-h-screen relative phone:ml-5 mid:mt-20 mid:ml-5 mac:mt-20 mac:ml-5">
      ...
      <div className="flex flex-row text-6xl font-bold mt-3 phone:mr-5 mid:mr-5 mac:hidden mal:hidden">
        <span className="text-[#6E00F2]">Front</span>
        <span>end</span>
      </div>
      <span className="text-6xl font-bold mt-3 phone:mr-5 phone:mt-0 mid:mr-5 mac:hidden mal:hidden">
        Developer
      </span>

      <p className="text-3xl mt-10 font-normal phone:text-xl phone:font-light phone:mt-8 phone:mr-5 mid:text-xl mid:font-light mid:mt-8 mid:mr-5 mac:text-xl mac:mr-5 mac:mt-5 mal:mr-5 mal:text-2xl">
