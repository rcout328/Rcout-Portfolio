...
const Mainpart = () => {
  return (
    <div className="flex flex-col ml-10 mt-40 phone:mt-20 min-h-screen relative phone:ml-5 mid:mt-20 mid:ml-5">
      <span className="text-3xl font-light">Hey,I'm Rc0ut</span>
      <div className="flex flex-row text-8xl font-bold mt-3 phone:hidden mid:hidden">
        <span className="text-[#6E00F2]">Front</span>
        <span>end Developer</span>
      </div>
      <div className="flex flex-row text-6xl font-bold mt-3 phone:mr-5 mid:mr-5">
        <span className="text-[#6E00F2]">Front</span>
        <span>end</span>
      </div>
      <span className="text-6xl font-bold mt-3 phone:mr-5 phone:mt-0 mid:mr-5">
        Developer
      </span>

      <p className="text-3xl mt-10 font-normal phone:text-xl phone:font-light phone:mt-8 phone:mr-5 mid:text-xl mid:font-light mid:mt-8 mid:mr-5">
        I'm a frontend developer based in Italy, I'll help you build beautiful
        websites your users will love.
      </p>
      <div className="mt-8 phone:mt-6 mid:mt-6">
