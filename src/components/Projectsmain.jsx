...
const Projectsmain = () => {
  return (
    <>
      ...
      <div className="flex flex-col ml-10 mr-10 mt-40 phone:mt-20 phone:mr-5 phone:ml-5 mid:mt-20 mid:mr-5 mid:ml-5 mac:mt-20 mac:mr-5 mac:ml-5 mal:mt-20 mal:ml-5 mal:mr-5">
        <div className="flex flex-row text-8xl font-bold mt-3 gap-4 phone:hidden mid:hidden mac:text-6xl mal:text-7xl">
          <span>My</span>
          <span className="text-[#6E00F2]">Best</span>
          <span>Creations</span>
        </div>
        <div className="flex flex-col text-8xl font-bold mt-3  phone:text-6xl mid:text-6xl mac:hidden mal:hidden">
        ...
        <h1 className="text-3xl mt-5 phone:text-xl phone:text-black/80 mid:text-xl mac:text-xl mal:text-2xl">
